...
class Books:
    ...
    def createTable(self):
        try:#creates books table upon trying to view
            mycursor.execute("CREATE TABLE books (product_id int(11) PRIMARY KEY AUTO_INCREMENT, year smallint UNSIGNED, title varchar(40), author varchar(40), genre varchar(30), price float(10), item varchar(8))")
