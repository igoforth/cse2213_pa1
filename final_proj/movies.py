...
class Movies:
    ...
    def createTable(self):
        try:
            mycursor.execute("CREATE TABLE movies (id int(11) PRIMARY KEY AUTO_INCREMENT, year smallint UNSIGNED, title varchar(40), production_company varchar(40), genre varchar(30), price float(10), item varchar(8))")
