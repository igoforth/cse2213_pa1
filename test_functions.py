...
@pytest.mark.parametrize("file,message", [("testing.txt", "File opened."), ("share.txt", "File not found"), ("", "File not found"), (42, "File not found")])
def test_openFile(file, message, capsys):
    openFile(file)
